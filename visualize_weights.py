...
# changed model to saved model
conv_layer_1 = tf.layers.conv2d(input_glimpses, filters=32, kernel_size=(3, 3), strides=(1, 1), padding='same', activation=tf.nn.relu)
...
train = tf.train.AdamOptimizer().minimize(loss, var_list=[feature_viz])
